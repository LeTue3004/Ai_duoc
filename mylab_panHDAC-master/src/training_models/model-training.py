...
#Configs
data_source         = "/home/mylab-pharma/Code/tuele/pan_HDAC/mylab_panHDAC-master/data/train_test_data/NoCL/20240321_pan_HDAC_train_test_data.xlsx"
#MACCS, Morgan2
fpts_name           = "MACCS"
fpts_bits           = 167
model_result_file   = f"/home/mylab-pharma/Code/tuele/pan_HDAC/mylab_panHDAC-master/results/KQDD/NoCL/20240514_{fpts_name}_{fpts_bits}_model_result.xlsx"
roc_fig_path        = f"/home/mylab-pharma/Code/tuele/pan_HDAC/mylab_panHDAC-master/results/ROC_fig/NoCL/20240411_{fpts_name}_{fpts_bits}_roc_fig.png"
model_saving_path   = "/home/mylab-pharma/Code/tuele/pan_HDAC/mylab_panHDAC-master/results/models/NoCL"
...
dump(rf, os.path.join(model_saving_path, f"rf_{fpts_name}_{X_Train[0].shape[0]}.joblib"))
dump(svm, os.path.join(model_saving_path, f"svm_{fpts_name}_{X_Train[0].shape[0]}.joblib"))
xgb.save_model(os.path.join(model_saving_path, f"xgb_{fpts_name}_{X_Train[0].shape[0]}.json"))
